...
class TodoItem(Base):
    ...
    worked_on_start: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    worked_on_duration_minutes: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, server_default=func.now())
